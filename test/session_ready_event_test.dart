...
void main() {
  ...
  group('SessionReadyEvent & Deduplication Unit Tests', () {
    ...
    test(
      '2. Deduplication Set filters duplicate final events for the same sessionId',
      () {
    ...
    test(
      ...
      () {
        ...
        final discussionEvent = SessionReadyEvent(
          sessionId: 'discussion_session_D',
    ...
    test(
      '4. Non-final events (isFinal = false) do NOT trigger Lecture final modal',
      () {
        final shownSessionIds = <String>{};
