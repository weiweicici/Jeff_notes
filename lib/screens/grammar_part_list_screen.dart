...
class GrammarPartListScreen extends StatefulWidget {
  const GrammarPartListScreen({super.key});
  @override
  State<GrammarPartListScreen> createState() => _GrammarPartListScreenState();
}

class _GrammarPartListScreenState extends State<GrammarPartListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_isLoading) {
      return Scaffold(
        appBar: AppBar(title: const Text('📖 语法学习')),
